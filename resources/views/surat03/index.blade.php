...
<div class="row container-fluid d-flex justify-content-center">
	<div class="col-md-12">
		<div class="card">
		    ...
		    <div class="card-body">
		    	<p>
		    		<a href="{{ route('surat03.create') }}" class="btn btn-primary">Tambah Data</a>
		    	</p>
		    		...
		    		<tbody>
		    			...
		    			<tr>
		    				...
		    				<td>
								...
								<form id="delete-form" action="{{ route('surat03.destroy', $data->id) }}" method="POST" style="display: none;">
									@csrf
									@method('DELETE')
								</form>
							</td>
