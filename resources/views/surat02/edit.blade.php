...
@section('title', 'Edit Surat RT 02')
	...
	<div class="col-md-10">
		<div class="card">
		    <div class="card-header">
		        <h3 class="card-title">Edit Surat RT 02</h3>
		    </div>
		    <div class="card-body">
		    	<form action="{{ route('surat02.update', $surat02->id) }}" method="POST" enctype="multipart/form-data">
                    {{ method_field('PUT') }}
		    		@csrf
