		...
		<div class="card">
		    ...
		    <div class="card-body">
		    	...
		    	<table class="table" id="example1">
		    		...
		    		<tbody>
		    			@foreach($surat02 as $data)
		    			<tr>
		    				<td>{{ $data->created_at->toDateString() }}</td>
							<td><a href="{{ route('surat02.download', $data->id) }}" target="_blank">Download File</a></td>
		    				...
		    				<td>
								...
								<form id="delete-form" action="{{ route('surat02.destroy', $data->id) }}" method="POST" style="display: none;">
									@csrf
									@method('DELETE')
								</form>
							</td>
