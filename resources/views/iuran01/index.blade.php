...
<div class="row container-fluid d-flex justify-content-center">
	<div class="col-md-12">
		<div class="card">
		    ...
		    <div class="card-body">
		    	<p>
		    		<a href="{{ route('iuran01.create') }}" class="btn btn-primary">Tambah Data</a>
		    	</p>
		    	<table class="table" id="example1">
		    		...
		    		<tbody>
		    			@foreach($iuran01 as $data)
		    			<tr>
		    				<td>{{ $data->created_at->toDateString() }}</td>
		    				<td>{{ $data->warga01->nama_warga }}</td>
							<td>{{ $data->warga01->alamat }}</td>
							...
							<th></th>
							<th></th>
							<th>@currency ($iuran01->sum('nominal'))</th>
							<th></th>
							<th></th>
		    		</tbody>
		    	</table>
