...
@section('title', 'Edit Iuran RT 03')
	...
	<div class="col-md-10">
		<div class="card">
		    <div class="card-header">
		        <h3 class="card-title">Edit Iuran RT 03</h3>
		    </div>
		    <div class="card-body">
		    	<form action="{{ route('iuran03.update', $iuran03->id) }}" method="POST">
                    {{ method_field('PUT') }}
		    		@csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            <input id="keterangan" type="text" name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" value="{{ $iuran03->keterangan }}" required autocomplete="keterangan" autofocus>
